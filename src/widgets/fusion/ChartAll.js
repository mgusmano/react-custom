...
window['drillDownState'] = function(stateName) {

}


class ChartAll extends React.Component {
  //title:Census Chart//title:
  //x:10//x:
  //y:10//y:
  //width:400//width:
  //height:600//height:
  ...
  renderComplete (e) {
    console.log(e)
    console.log(this.drillDownState)
    window['drillDownState'] = this.drillDownState
  ...
  //  const { chartType, dataSource } = this.props;
    ...
    return (
      ...
      <div className="FusionParent" style={{flex:'1',overflow:'hidden'}}>
